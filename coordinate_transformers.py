...
class IsobaricVelocityNumPyBackend(GenericDomainStrategy):
    ...
    def execute(self, *args, **kwargs):
        ...
        missing_val = float(kwargs.get("missing_val", -9999.0))
...
class IsentropicNumpyBackend(GenericDomainStrategy):
    ...
    def execute(self, *args, **kwargs):
        ...
        sub_mod = kwargs.get("SUBTERRANEAN_MODULE", "coordinate_transformers")
        sub_cls = kwargs.get("SUBTERRANEAN_PHYSICS", "StrictLorenzStrategy")
